...
internals.Pack.prototype._register = function (plugins, options, state, callback) {
    ...
    */
    ...
    Item.series(registrations, function (item, next) {
...
internals.Pack.prototype.start = function (callback) {
    ...
    Item.parallel(caches, function (cache, next) {
...
internals.Pack.prototype._apply = function (servers, func, args, callback) {
    ...
    Item.series(servers, function (server, next) {
...
internals.Pack.prototype._provisionCache = function (options, type, name, segment) {
    ...
    var settings = (options.expiresIn || options.expiresAt ? { expiresIn: options.expiresIn, expiresAt: options.expiresAt, staleIn: options.staleIn, staleTimeout: options.staleTimeout, generateTimeout: options.generateTimeout } : {});
...
internals.Pack.prototype._invoke = function (event, callback) {
    ...
    Item.series(exts.nodes, function (ext, next) {
...
internals.Pack.compose = function (manifest /*, [options], callback */) {
    ...
    Item.series(names, function (name, nextName) {
        ...
        */
        ...
        Item.series(plugins, function (plugin, nextRegister) {
