...
exports = module.exports = internals.Pack = function (options) {
    ...
    this._handlers = new Handlers(this);                                // Registered handlers
...
internals.Pack.prototype._register = function (plugin, options, callback, _dependencies) {
    ...
    root.handlers = self._handlers.handlers;
    ...
    root.handler = function (/* name, method, schema */) {
        ...
        return self._handlers.add.apply(self._handlers, args);
    };
...
internals.Pack.prototype._handler = function () {

    return this._handlers.add.apply(this._handlers, arguments);
};
