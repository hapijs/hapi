...
internals.Pack.prototype.register = function (plugins /*, [options], callback, skipDependencyCheck */) {
...
internals.Pack.prototype._register = function (plugins, options, servers, callback) {
    ...
    */
    ...
    Items.serial(registrations, function (item, next) {
        ...
        self._plugin(item, options, servers, next);
    }, callback);
};


internals.Pack.prototype._plugin = function (plugin, registerOptions, servers, callback) {
    ...
    var step = function (labels, subset) {
        ...
        var methods = {
            ...
            route: function (options) {
                ...
                internals.applySync(selection.servers, Server.prototype._route, [options, env]);
            },
            state: function () {

                internals.applySync(selection.servers, Server.prototype.state, arguments);
            },
            auth: {
                scheme: function () {

                    internals.applyChildSync(selection.servers, 'auth', 'scheme', arguments);
                },
                strategy: function () {

                    internals.applyChildSync(selection.servers, 'auth', 'strategy', arguments);
                }
            },
            ext: function () {

                internals.applySync(selection.servers, Server.prototype._ext, [arguments[0], arguments[1], arguments[2], env]);
            },
            dependency: function (deps, after) {
                ...
                deps = [].concat(deps);
                self._dependencies.push({ plugin: plugin.name, servers: selection.servers, deps: deps });

                if (after) {
                    self._after(after, deps, env, root);
                }
            },
            register: function (plugins /*, [options], callback */) {
                ...
                internals.Pack.prototype._register.call(self, plugins, options, selection.index, callback);
            }
        };
    ...
    var root = step(registerOptions.select, servers);
    ...
    root.after = function (func) {

        self._after(func, null, env, root);
    };
    ...
    root.views = function (options) {
        ...
        env.views = new Vision.Manager(options);
    };
...
internals.Pack.prototype._after = function (func, after, env, plugin) {

    this._afters = this._afters || new Topo();
    this._afters.add({ func: func, plugin: plugin }, { after: after, group: env.name });
};
...
internals.Pack.prototype.start = function (callback) {
    ...
    function (err) {
        ...
        var finalize = function (err) {
            ...
            internals.apply(self._servers, Server.prototype._start, null, function () {
...
internals.Pack.prototype.stop = function (options, callback) {
    ...
    internals.apply(this._servers, Server.prototype._stop, [options], function () {
...
internals.apply = function (servers, func, args, callback) {
