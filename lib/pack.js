...
internals.Pack.prototype.register = function (plugins /*, [options], callback */) {
    ...
    */
    ...
    Async.forEachSeries(registrations, function (item, next) {
        ...
        self._register(item, {}, dependencies, next);
    },
    function (err) {
...
internals.Pack.prototype._register = function (plugin, options, dependencies, callback) {
    ...
    root.register = function () {
        ...
        internals.Pack.prototype.register.apply(self, arguments);
    };
