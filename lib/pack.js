...
exports = module.exports = internals.Pack = function (options) {
    ...
    this._settings.debug = options.debug || Defaults.server.debug;
    ...
    this._methods = new Methods(this);                                  // Server methods and helpers
...
internals.Pack.prototype._register = function (plugin, options, callback, _dependencies) {
    ...
    root.helpers = self._methods.helpers;
    ...
    root.method = function (/* name, method, options */) {
        ...
        return self._methods.add.apply(self._methods, Array.prototype.slice.call(arguments).concat(env));
    };

    root.helper = function (/* name, method, options */) {

        return self._methods.addHelper.apply(self._methods, arguments);
    };
...
internals.Pack.prototype._helper = function () {

    return this._methods.addHelper.apply(this._methods, arguments);
};
...
internals.Pack.prototype._invoke = function (event, callback) {
    ...
    var handlers = this._ext._events[event];
    if (!handlers) {
