...
internals.Pack.prototype._handler = function (name, fn) {
    ...
    var predefinedSchemas = {
        'proxy': Schema.proxyHandlerSchema,
        'file': Schema.fileHandlerSchema,
        'directory': Schema.directoryHandlerSchema,
        'view': Schema.viewHandlerSchema,
    };
    var schema = predefinedSchemas[name] || Joi.any();
