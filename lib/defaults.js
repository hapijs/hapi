...
exports.server = {
    ...
    load: {
        maxHeapUsed: 1500 * 1024 * 1024,            // Reject requests when V8 heap is over 1500Mb (zero is no max)
        maxEventLoopDelay: 0,                       // Milliseconds of delay after which requests are rejected (zero is no max)
        eventLoopSampleInterval: 0,                 // Frequency of sampling the event loop delay in milliseconds
        eventLoopSampleSize: 3                      // Number of samples used to calculate an average
    },
