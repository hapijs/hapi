...
exports.fileHandler = function (route, filePath) {
    ...
    var absolutePath = exports.getRouteSourceFilePath();
...
exports.getRouteSourceFilePath = function () {

    // 0 - Files.getRouteSourceFilePath
    // 1 - Files.directoryHandler / Files.fileHandler
    // 2 - new Route
    // 3 - Server.addRoute
    // 4 - Server.addRoutes / **Caller
    // 5 - **Caller
