...
internals.Ext.prototype.invokePlugin = function (event, callback) {
    ...
    Async.forEachSeries(handlers, function (ext, next) {
        ...
        internals.Ext.runProtected(null, event, next, function (enter, exit) {

            enter(function () {

                ext.func(ext.plugin.root, exit);
            });
        });
    },
    function (err) {
