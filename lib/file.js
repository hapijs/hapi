...
exports.Response = internals.Response = function (path, settings) {
...
Utils.inherits(internals.Response, Response.Generic);


internals.Response.prototype._marshall = function (request, callback) {

    return exports.load(this.path, this.settings, this, callback);      // Ignoring callback second argument
};


exports.load = function (path, options, response, callback) {
    ...
    Fs.stat(filePath, function (err, stat) {
        ...
        response = response || new Response.Generic(fileStream);
        response.source = fileStream;
