    ...
    async _lifecycle(cycle, postCycle) {
        ...
        for (let i = 0; i < cycle.length; ++i) {
            ...
            if (this.response === null) {
                this._setResponse(response = Boom.badImplementation('Lifecycle methods called before the handler can only return an error, a takeover response, or a continue signal'));
                return;
            }
