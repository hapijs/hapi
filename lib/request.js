...
internals.Request.prototype._decorate = function (callback) {
    ...
    this.reply.view = function (templateName, context, viewSpecificSettings) {

        response = self._generateResponse(new Response.View(templateName, context, viewSpecificSettings), process);
        return response;
    };
};
