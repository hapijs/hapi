...
internals.Request.prototype._reply = function (exit) {
    ...
    var process = function () {
        ...
        Handler.invoke(self, 'onPreResponse', function (err) {
...
internals.Request.prototype._setResponse = function (response) {
    ...
    if (response.isBoom) {
        // Force a stack evaluation to avoid leaking the stack contexts
        // https://code.google.com/p/v8/issues/detail?id=3272
        response.stack;
    }
