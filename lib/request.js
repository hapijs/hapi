...
internals.Request.prototype.log = function (tags, data, timestamp) {
    ...
    if (this.server.pack._core._settings.debug &&
        this.server.pack._core._settings.debug.request &&
        Hoek.intersect(tagsMap, this.server.pack._core._settings.debug.request, true)) {
...
internals.Request.prototype._finalize = function () {
    ...
    this._protect.logger = this.server.pack;
};
