...
var IdGenerators = require('./id-generators');
...
exports = module.exports = internals.Request = function (server, req, res, options) {
    ...
    var idGenerator = server.settings.idGenerator;
    this.id = (typeof idGenerator === 'function') ?
        idGenerator(now) : // use custom fn
        IdGenerators[idGenerator](now); // otherwise use built-in
