            ...
            if (self._subscribers.hasOwnProperty(dest)) {
                ...
                if (subscriberQueue.length) {
                    ...
                    while (subscriberQueue.length) {
                        data.events.push(subscriberQueue.shift());                  // Shift events from the fixed queue to the temporary one
                    }
...
internals.Monitor.prototype._handle = function (eventName) {
    ...
    return function (context) {
        ...
        if (subscriptions &&
            ...
            var event = self._eventHandlers[eventName]()(context);
...
internals.Monitor.prototype._eventHandlers.request = function () {
    ...
    return function (request) {
        ...
        var event = {
            ...
            responseTime: Utils.getTimestamp() - request._analytics.startTime
        };
