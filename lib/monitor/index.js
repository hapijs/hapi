...
module.exports = Monitor = function (server) { // since Monitor is a "class", module.exports must be used (not exports)
...
Monitor.prototype._ops = function(client, url, monitor) {
    ...
    return function(){
        ...
        Async.parallel({
          oscpu: monitor.os.cpu,
          osdisk: monitor.os.disk,
          osload: monitor.os.loadavg,
          osmem: monitor.os.mem,
          osup: monitor.os.uptime,
          psup: monitor.process.uptime,
          psmem: monitor.process.memory,
          pscpu: monitor.process.cpu
