...
exports.Manager = internals.Manager = function (options, override) {
    ...
    extensions.forEach(function (extension) {
        ...
        if (config.compile &&
            ...
            config.module = null;                                       // Prevent module from being cloned
            engine.config = Hoek.applyToDefaults(defaults, config);
            config.module = engine.module;                              // Restore object to original state
        }
...
internals.Manager.prototype.render = function (filename, context, options, callback) {
    ...
    this._compile(templatePath, engine, settings, function (err, compiled) {
        ...
        self._compile(layoutPath, engine, settings, function (err, layout) {
            ...
            var layoutContext = Hoek.clone(context);
