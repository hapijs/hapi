...
exports.Manager = internals.Manager = function (options, override) {
    ...
    var defaults = Utils.applyToDefaultsWithShallow(Defaults.views, options, ['engines']);
    if (override) {
        Hoek.merge(defaults, override);
    }
    ...
    extensions.forEach(function (extension) {
        ...
        if (config.compile &&
            ...
            engine.config = Utils.applyToDefaultsWithShallow(defaults, config, ['module']);
        }
