...
exports.read = function (request, next) {
    ...
    req.on('end', function () {
        ...
        var unzip = function () {
            ...
            Zlib.unzip(payloadBuf, function (err, buffer) {
...
internals.isDeflate = function (compareBuf) {
    ...
    var validDeflate = new Buffer(2);
    validDeflate[0] = '0x78';
    validDeflate[1] = '0x9c';

    return compareBuf[0] === validDeflate[0] && compareBuf[1] === validDeflate[1];
};

internals.isGzip = function (compareBuf) {

    var validGzip = new Buffer(2);
    validGzip[0] = '0x1f';
    validGzip[1] = '0x8b';

    return compareBuf[0] === validGzip[0] && compareBuf[1] === validGzip[1];
};
