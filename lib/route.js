...
internals.pathRegexString = function () {
    ...
    */
    ...
    var literalParam = '(' + literalOptional + mixParam + literalOptional + ')';
    ...
    var regex = empty + '|' + path;
    return new RegExp(regex);
};


internals.Route.validatePathRegex = internals.pathRegexString();
