...
exports = module.exports = internals.Route = function (options, connection, env) {
    ...
    this.settings = Hoek.applyToDefaultsWithShallow(handlerDefaults, options.config || {}, ['bind']);
    ...
    if (this.method !== 'get' &&
        ...
        this.settings.payload.timeout = this.settings.payload.timeout !== undefined ? this.settings.payload.timeout : this.connection.settings.timeout.client;
