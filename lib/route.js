...
exports = module.exports = internals.Route = function (route, connection, plugin, options) {
    ...
    // Apply plugin authentication configuration (superseded by route authentication configuration)

    if (realm.modifiers.route.auth) {
        this.settings.auth = this.settings.auth || realm.modifiers.route.auth;
    }
