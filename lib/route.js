...
exports = module.exports = internals.Route = function (options, connection, env) {
    ...
    Hoek.assert(!this.settings.timeout.client || !socketTimeout || this.settings.timeout.client < socketTimeout, 'Client timeout must be shorter than socket timeout:', options.path);
    ...
    if (this.method !== 'get' &&
        ...
        this.settings.payload.maxBytes = this.settings.payload.maxBytes || this.connection.settings.payload.maxBytes;
        this.settings.payload.uploads = this.settings.payload.uploads || this.connection.settings.payload.uploads;
        this.settings.payload.failAction = this.settings.payload.failAction || 'error';
        this.settings.payload.timeout = this.settings.payload.timeout !== undefined ? this.settings.payload.timeout : this.settings.timeout.client;
    ...
    this.settings.files.relativeTo = this.settings.files.relativeTo || this._env.relativeTo || this.connection.settings.files.relativeTo;
