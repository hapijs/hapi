...
exports = module.exports = internals.Route = function (options, server, env) {
    ...
    this.path = (this.server.settings.router.isCaseSensitive ? options.path : options.path.toLowerCase());
    ...
    this._parsePath();      // Sets this.params, this.fingerprint, this._segments
...
internals.Route.prototype._test = function (path, params, paramsArray) {
    ...
    if (!this.params.length) {
        ...
        if (pl === sl ||
            pl >= sl && this._segments[sl - 1].isWildcard) {
