...
exports = module.exports = internals.Route = function (options, server) {
    ...
    */
    ...
    if ((typeof this.config.handler === 'object') && !!this.config.handler.proxy) {
        ...
        this.file = new File(this.path, this.config.handler.file);
        this.config.handler = this.file.handler();
    }
    else if ((typeof this.config.handler === 'object') && !!this.config.handler.directory) {
        this.directory = new Directory(this.path, this.config.handler.directory);
        this.config.handler = this.directory.handler();
    }
