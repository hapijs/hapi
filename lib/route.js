...
exports = module.exports = internals.Route = function (options, server) {
    ...
    */
    ...
    if ((typeof this.config.handler === 'object') && !!this.config.handler.proxy) {
        ...
        this.config.handler = Files.fileHandler(this.path, this.config.handler.file);
    }
    else if ((typeof this.config.handler === 'object') && !!this.config.handler.directory) {
        this.config.handler = Files.directoryHandler(this.path, this.config.handler.directory);
    }
