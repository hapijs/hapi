...
exports.serverOptions = function (options, next) {
    ...
    var optionsSchema = {
        ...
        debug: Joi.Types.Object().nullOk().allow(false).allow(true),
        batch: Joi.Types.Object().nullOk().allow(false).allow(true),
        docs: Joi.Types.Object().nullOk().allow(false).allow(true),
        views: Joi.Types.Object().nullOk().allow(false).allow(true),
        cache: Joi.Types.Object().nullOk().allow(false).allow(true)
    };
