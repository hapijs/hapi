...
module.exports = internals.Server = function (/* host, port, options */) {        // all optional
    ...
    if (this.settings.authentication) {
        Utils.assert(this.settings.authentication.tokenEndpoint &&
                     this.settings.authentication.verifyTicketFunc &&
                     this.settings.authentication.getAppFunc &&
                     this.settings.authentication.checkAuthorizationFunc &&
                     this.settings.authentication.encryptionPassword, 'Invalid authentication configuration');

        if (this.settings.authentication.ozSettings) {
            Oz.settings.set(this.settings.authentication.ozSettings);
        }
