...
var Pack = null;                            // Delayed required
...
exports = module.exports = internals.Server = function (/* host, port, options */) {        // all optional
    ...
    Pack = Pack || require('./pack');               // Delayed required to avoid circular dependencies
...
internals.Server.prototype.method = function (name, method, options) {
