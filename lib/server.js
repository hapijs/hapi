...
exports = module.exports = internals.Server = function (options, _core) {
...
internals.Server.prototype._clone = function (connection) {

    var clone = new internals.Server(null, this._core);
...
internals.Server.prototype.connection = internals.Server.prototype.server = function (/* host, port, options */) {
