...
var View = require('./response/view');
...
module.exports = internals.Server = function (/* host, port, options */) {        // all optional
    ...
    if (this.settings.views) {
        // this.Views = new View(this.settings.views);
        // this.Views = new Response.Views(this.settings.views);
        this.Views = View.Views.init(this.settings.views);
    }
