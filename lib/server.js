...
exports = module.exports = internals.Server = function (/* host, port, options */) {        // all optional
    ...
    */
    ...
    this.handlers = {
        proxy: {
            func: Proxy.handler,
            schema: Schema.routeHandlerObjectSchema.proxy
        },
        file: {
            func: File.handler,
            schema: Schema.routeHandlerObjectSchema.file
        },
        directory: {
            func: Directory.handler,
            schema: Schema.routeHandlerObjectSchema.directory
        },
        view: {
            func: Views.handler,
            schema: Schema.routeHandlerObjectSchema.view
        }
    };
};
