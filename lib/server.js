...
internals.Server.prototype.handler = function (name, method) {

    var nativeHandlers = [Proxy.handler, File.handler, Directory.handler, Views.handler];
    var builtin = nativeHandlers.indexOf(method) !== -1;
