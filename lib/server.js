...
Server.prototype.unhandledRoute = function (request) {
    ...
    if (this.settings.ext.onUnknownRoute) {
        ...
        if (this.settings.ext.onUnknownRoute instanceof Array) {
        ...
        this.respond(res, error.code, { error: error.text, message: error.message, code: error.code });
