...
exports = module.exports = internals.Server = function (options) {
    ...
    this._settings = Hoek.applyToDefaults(Defaults.server, options);
    this._settings.connections = Hoek.applyToDefaults(Defaults.connection, this._settings.connections || {});
