...
internals.Plugin.prototype.render = function (template, context, options, callback) {
    ...
    var manager = this.realm.plugins.vision.manager || this.root.realm.plugins.vision.manager;
    Hoek.assert(manager, 'Missing views manager');
    return manager.render(template, context, options, callback);
};
...
internals.Plugin.prototype.views = function (options) {
    ...
    this.realm.plugins.vision.manager = new Vision.Manager(options);
};
