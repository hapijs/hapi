...
internals.table = function (host) {
    ...
    return this.connections[0]._router.table(host);
};
...
internals.inject = function (options, callback) {
    ...
    var needle = this.connections[0]._dispatch({ credentials: options.credentials });
...
internals.location = function (uri, request) {
    ...
    return Headers.location(uri, this.connections[0], request);
};
