...
internals.Plugin.prototype.register = function (plugins /*, [options], callback */) {
    ...
    if (this.realm.modifiers.route.prefix ||
        ...
        this.realm.modifiers.route.auth) {
        ...
        options.routes.auth = this.realm.modifiers.route.auth || options.routes.auth;
    }
    ...
    */
        ...
        const registration = {
            ...
            options: {
                ...
                routes: {
                    ...
                    auth: plugin.routes.auth || options.routes.auth
                },
    ...
    const each = (item, next) => {
        ...
        selection.realm.modifiers.route.auth = item.options.routes.auth;
