...
internals.routeConfigSchema = {
    ...
    validate: T.Object({
        ...
        failAction: [T.String().valid('error', 'log'), T.Function()],
        response: internals.routeOptionsSchema.config                   // Backwards compatibilty
    }),
    errorHandler: T.Object({
        query: T.Function().nullOk(),
        payload: T.Function().nullOk(),
        path: T.Function().nullOk(),
        response: T.Function().nullOk()
    }),
    response: T.Object({
