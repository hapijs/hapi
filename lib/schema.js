...
internals.multipart = [
    T.String().valid('file', 'stream').allow(false),
    T.Object({
        mode: T.String().valid('file', 'stream').required(),
        encoding: T.String(),
        maxFieldBytes: T.Number(),
        maxFields: T.Number(),
        uploadDir: T.String(),
        hash: T.String().valid('sha1', 'md5')
    })
];
...
internals.serverSchema = {
    ...
    cache: [T.String().nullOk(), T.Object({
        ...
        partition: T.String(),
        host: T.String(),
        location: [T.String(), T.Array(), T.Object()],
        port: T.Number(),
        username: T.String(),
        password: T.String(),
        poolSize: T.Number(),
    ...
    json: T.Object({
        replacer: [T.Function().nullOk(), T.Array()],
        space: T.Number().nullOk()
    }),
    labels: [T.String(), T.Array()],
    location: T.String().emptyOk(),
    payload: T.Object({
        maxBytes: T.Number(),
        multipart: internals.multipart
    }),
    plugins: T.Object(),
    router: T.Object({
...
internals.routeConfigSchema = {
    ...
    validate: T.Object({
        ...
        failAction: [T.String().valid('error', 'log', 'ignore'), T.Function()],
