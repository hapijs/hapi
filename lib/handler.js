...
exports.configure = function (handler, route) {
    ...
    if (typeof handler === 'object') {
        ...
        if (handlerKey in handlerTypes) {
            return handlerTypes[handlerKey](route, handler[handlerKey]); // Return valute of handler function
        }
    }
...
exports.registerHandler = function (name, method) {
    ...
    Utils.assert(typeof name === 'string', 'Not a valid handler name');
    Utils.assert(typeof method === 'function', 'Not a valid method parameter');
...
exports.registerHandler("views", Views.handler);
