...
exports.configure = function (handler, route) {
    ...
    Utils.assert((typeof handler === 'function') ^ !!handler.proxy ^ !!handler.file ^ !!handler.directory ^ !!handler.view, 'Handler must be a function or be an object with a proxy, file, directory, or view:', route.settings.path);
