...
exports.replyInterface = function (request, finalize, base) {
    ...
    var viewsManager = (base && base.env && base.env.views) || request._route._env.views || request.server._env.views;
    if (viewsManager) {
...
exports.defaults = function (method, handler, server) {
    ...
    if (typeof handler === 'object') {
        ...
        var serverHandler = server._core._handlers[type];
...
exports.configure = function (handler, route) {
    ...
    if (typeof handler === 'object') {
        var type = Object.keys(handler)[0];
        var serverHandler = route.server._core._handlers[type];
...
exports.invoke = function (request, event, callback) {
    ...
    var exts = request.connection._ext._events[event];
    if (!exts) {
