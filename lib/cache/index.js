...
exports.Policy = internals.Policy = function (prefix, config, cache) {
...
internals.Policy.prototype.get = function (key, callback) {
    ...
    this._cache.get(this._prefix + ':' + key, function (err, cached) {
        ...
        cached.isStale = age >= this.rule.staleIn;
        return callback(null, cached);
    });
};
...
internals.Policy.prototype.set = function (key, value, ttl, callback) {
    ...
    this._cache.set(this._prefix + ':' + key, value, ttl, callback);
};


internals.Policy.prototype.drop = function (key, callback) {

    this._cache.drop(this._prefix + ':' + key, callback);
};
