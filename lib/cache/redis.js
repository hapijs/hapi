...
internals.Connection.prototype.start = function (callback) {
    ...
    this.client = Redis.createClient(this.settings.port || internals.defaults.port, this.settings.host || internals.defaults.host)
...
internals.Connection.prototype.get = function (key, callback) {
    ...
    this.client.get(internals.generateKey(key), function (err, result) {
...
internals.Connection.prototype.set = function (key, value, ttl, callback) {
    ...
    var cacheKey = internals.generateKey(key);
...
internals.Connection.prototype.drop = function (key, callback) {
    ...
    this.client.del(internals.generateKey(key), function (err) {
...
internals.generateKey = function (key) {

    return encodeURIComponent(this.partition) + ':' + encodeURIComponent(key.segment) + ':' + encodeURIComponent(key.id);
};
