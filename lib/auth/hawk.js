...
internals.Scheme.prototype.authenticatePayload = function (payload, credentials, callback) {

    var isValid = Hawk.validatePayload(payload, credentials, credentials.hash);
