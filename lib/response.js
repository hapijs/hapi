...
exports.File = internals.File = function(filePath) {

    var stream = Fs.createReadStream(filePath);
    internals.Stream.call(this, stream);
    this._tag = 'file';

    return this;
};

NodeUtil.inherits(internals.File, internals.Stream);
...
exports.generateResponse = function (result, onSend) {
    ...
    if (result === null ||
        ...
        else if (result instanceof internals.File) {
            response = result;
        }
