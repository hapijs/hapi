    ...
    if (options.etag &&
        ...
        for (let i = 0; i < ifNoneMatch.length; ++i) {
            ...
            if (options.vary) {
                ...
                const encoders = request.server.root._compression.encodings;
...
internals.Response.prototype._prepare = function () {
...
internals.Response.prototype._marshal = async function () {
...
internals.Response.prototype._streamify = function (source) {
