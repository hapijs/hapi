...
internals.Directory.prototype._serveListing = function (callback) {
    ...
    Fs.readdir(self._path + self._childPath, function (err, files) {
        ...
        var html = internals.htmlStart(self._routePath);
...
internals.htmlStart = function (routePath) {

    return '<html><head><title>Directory listing</title></head><body><h1>' + routePath + '</h1><ul>';
};
