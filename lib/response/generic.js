...
internals.Generic.prototype._prepare = function (request, callback) {
    ...
    if (request.jsonp) {
        ...
        this.header('Content-Length', parseInt(this._headers['Content-Length'], 10) + request.jsonp.length + 3);
        this._payload = [request.jsonp, '(', this._payload.replace(/\u2028/g, '\\u2028').replace(/\u2029/g, '\\u2029'), ');'];
    }
