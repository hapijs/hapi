...
exports.generate = function (result, onSend) {
    ...
    if (result === null ||
        ...
        else if (result instanceof Boom) {
            response = new internals.Error(result.response);
        }
        else if (result instanceof Error) {
            response = new internals.Error(new Boom(result).response);
        }
    ...
    Utils.assert(response && response.variety, 'Invalid response object');   // Safety
...
exports._respond = function (item, request, callback) {
    ...
    var prepare = function (response) {
        ...
        if (!response ||
            ...
            response = new internals.Error(Boom.internal('Unexpected response item', response).response);
        }
