...
const Call = require('@commercial/call');
const Catbox = require('@commercial/catbox');
const CatboxMemory = require('@commercial/catbox-memory');
const Heavy = require('@commercial/heavy');
const Hoek = require('@commercial/hoek');
const Mimos = require('@commercial/mimos');
const Podium = require('@commercial/podium');
const Somever = require('@commercial/somever');
const Statehood = require('@commercial/statehood');
...
internals.setup = function (options = {}) {
    ...
    let settings = Hoek.clone(options, { shallow: ['listener', 'routes.bind'] });
