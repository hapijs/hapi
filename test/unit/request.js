...
describe('Request', function () {
    ...
    describe('#_setUrl', function () {
        ...
        it('does not throw when path is missing from request and execute is called', function (done) {
    ...
    describe('path normalization', function () {
        ...
        it('does not normalize a path when normalization is disabled', function (done) {
