...
Current version: [![Current Version](https://img.shields.io/npm/v/hapi.svg)](https://www.npmjs.org/package/hapi) ([release notes](https://github.com/hapijs/hapi/issues?labels=release+notes&page=1&state=closed)) [![Build Status](https://secure.travis-ci.org/hapijs/hapi.svg)](http://travis-ci.org/hapijs/hapi)
