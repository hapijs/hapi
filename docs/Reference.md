...
- [Request object](#request-object)
  ...
  - [`request` methods](#request-methods)
    ...
    - [`request.reply([result])`](#requestreplyresult)
      ...
      - [`request.reply.hold()`](#requestreplyhold)
      - [`request.reply.send()`](#requestreplysend)
...
- [`error`](#error)
    ...
    - [`unauthorized(error, scheme, attributes)`](#unauthorizederror-scheme-attributes)
    - [`unauthorized(error, wwwAuthenticate)`](#unauthorizederror-wwwauthenticate)
...
- [Plugin Interface](#plugin-interface)
  ...
  - [Root methods](#root-methods)
    ...
    - [`plugin.cache(options, segment)`](#plugincacheoptions-segment)
  - [Selectable methods](#selectable-methods)
